...
// === Пиксели + глюки (оставляем как есть)
...
const login = async () => {
  try {
    ...
    // ----------------------------------------------------
    // 🔍 DEBUG: показываем расшифрованный токен в консоль
    // ----------------------------------------------------
    try {
    ...
    // 🟢 RealUser онлайн
    if (user.realUserId) {
      console.log("[SOCKET] RealUser online →", user.realUserId)
...
// ===============================================
// 🔶 Fake Application (оставлено как есть)
// ===============================================
